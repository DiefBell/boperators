...
This is the core library and API, and isn't designed to be used directly. Instead, you can use the [Boperators CLI](https://www.npmjs.com/package/@boperators/cli) or our plugins for [compiling with `tsc`](https://www.npmjs.com/package/@boperators/plugin-tsc), [bundling with webpack](https://www.npmjs.com/package/@boperators/webpack-loader), or for [running directly with Bun](https://www.npmjs.com/package/@boperators/plugin-bun).
