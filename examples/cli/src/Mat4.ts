...
export class Mat4 {
	...
	// Mat4 × Mat4 → Mat4 (matrix multiply), and Mat4 × Vec3 → Vec3 (transform point)
	static "*"(a: Mat4, b: Mat4): Mat4;
	static "*"(a: Mat4, b: Vec3): Vec3;
	static "*"(a: Mat4, b: Mat4 | Vec3): Mat4 | Vec3 {
	...
	static "=="(a: Mat4, b: Mat4): boolean {
		return a.m.every((v, i) => v === b.m[i]);
	}
